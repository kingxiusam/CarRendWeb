...
var treeMenu = [
	{ level:1, name:"车辆管理"},
	{ level:2, name:"车辆列表", ico:"images/icon_default.gif",link:"<%=path%>/car/Car_query_success.jsp"},
	{ level:1, name:"客户管理"},
	{ level:2, name:"客户列表", ico:"images/icon_default.gif",link:"<%=path%>/Curstomers/Curstomers_query_success.jsp"},
	{ level:1, name:"司机管理"},
	{ level:2, name:"司机信息", ico:"images/icon_default.gif",link:"<%=path%>/Driver/Driver_query_success.jsp"},
	{ level:1, name:"公告管理", ico:"images/icon_default.gif",link:"welcome.html"},
	//{ level:1, name:"结算中心", ico:"images/icon_default.gif"},
	{ level:1, name:"导入导出数据", ico:"images/icon_default.gif",link:"DateMaker.jsp"},
	{level:1, name:"退出", ico:"images/icon_default.gif",link:"Users_login.jsp"}
